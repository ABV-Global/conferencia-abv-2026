...
const files = ['index.html', 'styles.css', 'assets/cartaz.jpg', 'assets/emblema.png', 'assets/fonts/old-london.ttf', 'assets/fonts/roboto-regular.ttf', 'assets/fonts/roboto-bold.ttf', 'assets/fonts/roboto-italic.ttf', 'assets/fonts/roboto-bold-italic.ttf', 'assets/fonts/Roboto-OFL.txt', 'assets/fonts/SOURCES.md'];
const html = await readFile(resolve(root, 'index.html'), 'utf8');
if ((html.match(/<h1\b/g) || []).length !== 1) throw new Error('A página deve ter um único título h1.');
if (html.includes('<form') || html.includes('lugar reservado')) throw new Error('Não publicar um formulário sem registo real.');
